...
export default function CategorySlider() {
  ...
  return (
    <div className="relative py-12 px-4 max-w-300 mx-auto  bg-white group/container">
      <div
        ref={scrollRef}
                ...
                >
                  <div className="relative aspect-4/5 bg-[#e1e1de] overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 text-white pointer-events-none">
                      <h3 className="text-2xl! font-semibold! leading-tight drop-shadow-lg  tracking-tight transform transition-transform duration-300 group-hover:-translate-y-1">
                        {cat.name}
                      </h3>
                      {cat.Products && (
                        <p className="mt-2 text-[16px] md:text-base font-medium drop-shadow-md opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
      ...
      {!isPending && (
        <div className="max-w-300 mx-auto h-0.5 bg-gray-200 relative mt-4 overflow-hidden rounded-full">
          <div
...
const CategorySkeleton = () => {
  return (
    <div className="min-w-52 max-h-52 shrink-0 animate-pulse">
      <div className="relative aspect-4/5 bg-[#e1e1de] overflow-hidden rounded-xl">
        {/* Image Placeholder with subtle shimmer */}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
          {/* Category Name */}
          <div className="h-8 w-40 bg-white/40 rounded mb-3" />
